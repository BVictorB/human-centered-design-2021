- [:raising_hand: &nbsp; Human Centered Design](#-raising-hand---nbsp--human-centered-design)
  * [:information_desk_person: &nbsp; User scenario](#-information-desk-person---nbsp--user-scenario)
    + [Who?](#who-)
    + [What?](#what-)
    + [How?](#how-)
    + [Why?](#why-)
  * [:boom: &nbsp; Challenges](#-boom---nbsp--challenges)
  * [:fireworks: &nbsp; Concept](#-fireworks---nbsp--concept)
  * [:page_with_curl: &nbsp; Features](#-page-with-curl---nbsp--features)
  * [:one: &nbsp; First test with Eric](#-one---nbsp--first-test-with-eric)
    + [Preparations](#preparations)
    + [Testing](#testing)
    + [Insights](#insights)
    + [Iterations](#iterations)
  * [:two: &nbsp; Second test with Eric](#-two---nbsp--second-test-with-eric)
    + [Preparations](#preparations-1)
    + [Testing](#testing-1)
    + [Insights](#insights-1)
    + [Iterations](#iterations-1)
  * [:three: &nbsp; Third test with Eric](#-three---nbsp--third-test-with-eric)
  ...
  * [:mortar_board: &nbsp; Final product](#-mortar-board---nbsp--final-product)
  * [:high_brightness: &nbsp; Conclusion](#-high-brightness---nbsp--conclusion)
    + [Do's](#do-s)
    + [Dont's](#dont-s)
  * [:books: &nbsp; Tech stack](#-books---nbsp--tech-stack)
  * [:open_file_folder: &nbsp; Live version](#-open-file-folder---nbsp--live-version)
  * [:scroll: &nbsp; License](#-scroll---nbsp--license)
  * [:inbox_tray: &nbsp; Install](#-inbox-tray---nbsp--install)  
